      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-white px-6 pt-20">
        ...
        >
          <div className="relative inline-block mb-12">
            ...
            >
              <div className="w-full h-full bg-slate-100 rounded-2xl flex items-center justify-center text-slate-400 group relative overflow-hidden border-2 border-dashed border-brand-primary/20">
                <Users className="w-16 h-16 mb-2 opacity-20" />
                <p className="text-[10px] font-black uppercase tracking-[0.3em] absolute bottom-6 text-brand-primary/40">Sua Foto Aqui</p>
